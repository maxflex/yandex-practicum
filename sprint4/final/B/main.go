...
Поэтому можно сразу инициировать хэштаблицу размером m=10^5

Разрешение коллизий: метод цепочек
Хотя коллизий не будет, т.к. по условию "в таблице хранятся уникальные ключи.",
значит, каждый попадёт в свою уникальную корзину при m=10^5

В задаче выбрано m=100003 - ближайшее простое больше 10^5, хотя это необязательно, т.к. коллизий не будет
*/
package main
